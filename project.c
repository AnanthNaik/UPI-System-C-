...
// Function to input data of user from structure to string.
void filldata(data *n, char *pho, char *pasw)
{
    n->phone = pho;
    n->pas = pasw;
...
/* Function To change password of the user.  rename proj.csv to temp.csv.makes new file proj.csv and put s modified data in it.And then deletes temp.csv.*/
void cpass(data *n)
{
...
/*Function To transact amount in another user's account.  rename proj.csv to temp.csv.makes new file proj.csv and put s modified data in it.And then deletes temp.csv.*/
void transaction( data *n)
{
    char rec[11];
